...
- [Weekly 401/m3180 q3 converted.py](<../my-submissions/Weekly 401/m3180 q3 converted.py>)
- [Weekly 401/m3180 q3 v2.py](<../my-submissions/Weekly 401/m3180 q3 v2.py>)
- [Weekly 401/m3180 q3.c](<../my-submissions/Weekly 401/m3180 q3.c>)
### Python
#### [m3180 q3 converted.py](<../my-submissions/Weekly 401/m3180 q3 converted.py>)
```Python
...
#### [m3180 q3 v2.py](<../my-submissions/Weekly 401/m3180 q3 v2.py>)
```Python
# https://leetcode.com/problems/find-the-n-th-value-after-k-seconds/description/
...
### C
#### [m3180 q3.c](<../my-submissions/Weekly 401/m3180 q3.c>)
```C
