...
- [h726 Daily v1.py](<../my-submissions/h726 Daily v1.py>)
- [h726 Daily v2 More Abstraction and Less Indents.py](<../my-submissions/h726 Daily v2 More Abstraction and Less Indents.py>)
### Python
#### [h726 Daily v1.py](<../my-submissions/h726 Daily v1.py>)
```Python
class Solution:
